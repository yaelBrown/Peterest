...
export default class Register extends Component {
  ...
  handleSubmit = () => {
    ...
    console.log("handle submit was ran")
    if (n === "" || 
      p === "" || 
      e === "" || 
      l === "") {
                        ...
                        <div className="elementor-widget-container">
                          <div className="beehive-login-element beehive-element default">
                              <div className="login-form-wrapper">
                                <form onSubmit={() =>
                                    this.handleSubmit()} id="element-login-form" className="beehive-login-form element-login-form">
                                    ...
                                    <div className="beehive-login-result" />
                                      <div className="submit">
                                          <button 
                                            ...
                                            // className="wide submit-login ellipsis" 
                                            // name="submit"
                                      ...
                                      <div className="register-link">
                                          <a href="/index2">
                                          <p className="color-primary" style={{margin: "auto", width: "fit-content"}} >Return to Login</p>
                                          </a>
                                      </div>
                                </form>
                                </div>
