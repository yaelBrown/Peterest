          ...
          <aside id="buddypress_sidebar" className="widget-area sidebar-widget-area sticky-sidebar">
            <div id="bp_core_members_widget-2" className="widget widget_bp_core_members_widget buddypress widget" style={{}}>
              ...
              <ul id="members-list" className="item-list" aria-live="polite" aria-relevant="all" aria-atomic="true">
                ...
                <li className="vcard">
                  <div className="item-avatar">
                    <a href="https://mythemestore.com/beehive-preview/members/razor/" className="bp-tooltip" data-bp-tooltip="Sephiroth"><img loading="lazy" src="https://mythemestore.com/beehive-preview/wp-content/uploads/avatars/1/6005b5c352343-bpthumb.png" className="avatar user-1-avatar avatar-50 photo" width={50} height={50} alt="ybybProfile of Sephiroth" /></a>
                  </div>
                  <div className="item">
                ...
                <li className="vcard">
                  <div className="item-avatar">
                    <a href="https://mythemestore.com/beehive-preview/members/jennie/" className="bp-tooltip" data-bp-tooltip="Jennie Ferguson"><img loading="lazy" src="https://mythemestore.com/beehive-preview/wp-content/uploads/avatars/16/5e2d07dbca09a-bpthumb.jpg" className="avatar user-16-avatar avatar-50 photo" width={50} height={50} alt="ybybProfile of Jennie Ferguson" /></a>
                  </div>
                  <div className="item">
                ...
                <li className="vcard">
                  <div className="item-avatar">
                    <a href="https://mythemestore.com/beehive-preview/members/jonathon/" className="bp-tooltip" data-bp-tooltip="John Thompson"><img loading="lazy" src="https://mythemestore.com/beehive-preview/wp-content/uploads/avatars/14/5e2d01291b6b9-bpthumb.jpg" className="avatar user-14-avatar avatar-50 photo" width={50} height={50} alt="ybybProfile yb of John Thompson" /></a>
                  </div>
                  <div className="item">
                ...
                <li className="vcard">
                  <div className="item-avatar">
                    <a href="https://mythemestore.com/beehive-preview/members/sophia/" className="bp-tooltip" data-bp-tooltip="Sophia Lee"><img loading="lazy" src="https://mythemestore.com/beehive-preview/wp-content/uploads/avatars/6/5e2cccd55f95b-bpthumb.jpg" className="avatar user-6-avatar avatar-50 photo" width={50} height={50} alt="ybybProfile yb of Sophia Lee" /></a>
                  </div>
                  <div className="item">
                ...
                <li className="vcard">
                  <div className="item-avatar">
                    <a href="https://mythemestore.com/beehive-preview/members/alexis/" className="bp-tooltip" data-bp-tooltip="Alexis Clark"><img loading="lazy" src="https://mythemestore.com/beehive-preview/wp-content/uploads/avatars/12/5e2cfd5d1d7c0-bpthumb.jpg" className="avatar user-12-avatar avatar-50 photo" width={50} height={50} alt="ybybProfile yb of Alexis Clark" /></a>
                  </div>
                  <div className="item">
                ...
                <li className="vcard">
                  <div className="item-avatar">
                    <a href="https://mythemestore.com/beehive-preview/members/brian/" className="bp-tooltip" data-bp-tooltip="Brian Walton"><img loading="lazy" src="https://mythemestore.com/beehive-preview/wp-content/uploads/avatars/9/5e2ce3f5bcd91-bpthumb.jpg" className="avatar user-9-avatar avatar-50 photo" width={50} height={50} alt="ybybProfile yb of Brian Walton" /></a>
                  </div>
                  <div className="item">
